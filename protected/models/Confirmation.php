 ...
 * @property string $accuiredshares
...
class Confirmation extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('paidamount, accuiredshares', 'length', 'max'=>20),
			array('reference_id', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('acc_nr, isin, curr_date, currentnav, paidamount, accuiredshares, reference_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('accuiredshares',$this->accuiredshares,true);
